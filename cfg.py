...
THREADS = 2 #number of threads used to generate new fractals. if set to 1, there will be no threading done.
...
MAX_ITERS = 50 #used for generating fractals. see documentation on wikipedia!